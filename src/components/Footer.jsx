...
const socialLinks = {
  ...
  LinkedIn:
    "https://www.linkedin.com/company/york-media-solutions/posts/?feedView=all",
};
    ...
    <footer className="bg-[#0d241d] text-white/65 pt-20 pb-8">
        ...
        <div>
          <Link to="/" className="flex items-center gap-2 mb-4">
            ...
            <span className="font-display font-semibold text-white text-lg">
              York Media Solutions
            </span>
          </Link>

          <p className="text-sm leading-relaxed max-w-xs">
            Outdoor advertising, transit branding and brand activation since
            2007. Thoughtful media that moves naturally through the world.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            <li className="flex gap-3">
              <MapPin
                size={18}
                className="shrink-0 text-[#a9b9a6]"
              />
      ...
      <div className="border-t border-white/10 pt-6">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-2 text-xs text-white/40">
          <p>
            &copy; {new Date().getFullYear()} York Media Solutions. All rights
            reserved.
          </p>

          <p>Founder: Nitin Vashist</p>
        </div>
      </div>
    </footer>
  );
